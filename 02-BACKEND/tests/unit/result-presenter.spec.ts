...
import { presentResult } from '../../src/modules/assessment/result-presenter';
import type {
  ResultDomainScore,
  ResultResponse,
  DomainCode,
} from '../../src/modules/assessment/assessment.dto';
import { DOMAIN_LABELS_EN, DOMAIN_LABELS_AR } from '../../src/modules/assessment/assessment-definition';
